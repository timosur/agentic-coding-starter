...
handoffs:
  - label: Take Screenshot
    agent: "Design: Screenshot"
    prompt: "Screen design is created. Capture a screenshot for documentation."
  - label: Shape Another Section
    agent: "Design: Shape Section"
    prompt: "Screen design is done. Define the specification for the next section."
  - label: Assemble Clickdummy
    agent: "Design: Clickdummy"
    prompt: "Screen designs are ready. Assemble a navigable clickdummy prototype."
---
...
Read `design/product/product-roadmap.md` to get the list of available sections.
...
- `design/product/sections/[section-id]/spec.md`
- `design/product/sections/[section-id]/data.json`
- `design/product/sections/[section-id]/types.ts`
...
- Check if `design/product/design-system/colors.json` exists
- Check if `design/product/design-system/design-system.json` exists
...
- Check if `design/src/shell/components/AppShell.tsx` exists
...
Create the main component file at `design/src/sections/[section-id]/components/[ViewName].tsx`.
...
**If `design/product/design-system/colors.json` exists:**
...
**If `design/product/design-system/typography.json` exists:**
...
**If `design/product/design-system/design-system.json` exists with brand identity fields:**
...
Create sub-components at `design/src/sections/[section-id]/components/[SubComponent].tsx`.

## Step 8: Create the Preview Wrapper

Create a preview wrapper at `design/src/sections/[section-id]/[ViewName].tsx` (note: this is in the section root, not in components/).
...
Create an index file at `design/src/sections/[section-id]/components/index.ts` to cleanly export all components.
...
- `design/src/sections/[section-id]/components/[ViewName].tsx`
- `design/src/sections/[section-id]/components/[SubComponent].tsx` (if created)
- `design/src/sections/[section-id]/components/index.ts`

**Preview wrapper** (for Design OS only):

- `design/src/sections/[section-id]/[ViewName].tsx`
