...
handoffs:
  - label: Sketch Data Shape
    agent: "Design: Data Shape"
    prompt: "Roadmap is defined. Sketch the core entities and relationships."
  - label: Define Design System
    agent: "Design: Design System"
    prompt: "Roadmap is defined. Define the visual identity — colors, typography, brand."
---
...
First, check if `design/product/product-roadmap.md` exists.
...
Wait for the user's response. Once they describe the changes, update `design/product/product-roadmap.md` accordingly.
...
Read `design/product/product-overview.md`. If it doesn't exist:
...
Once the user has confirmed the sections they want, create `design/product/product-roadmap.md` with this exact format:
...
"I've created your product roadmap at `design/product/product-roadmap.md` with [N] sections:
