...
handoffs:
  - label: Shape a Section
    ...
    prompt: "Shell is designed. Define the specification for the first section."
---
...
1. Read `design/product/product-overview.md` — Product name and description
2. Read `design/product/product-roadmap.md` — Sections for navigation
3. Check if `design/product/design-system/colors.json` and `design/product/design-system/typography.json` exist
...
Check if `design/product/design-system/design-system.json` exists and contains personality, voice, or uiStyle fields.
...
Create the shell components at `design/src/shell/components/`:
...
Create `design/src/shell/ShellPreview.tsx` — a preview wrapper for viewing the shell in Design OS:
...
- Read `design/product/design-system/colors.json`
...
- Read `design/product/design-system/typography.json`
...
- `design/product/shell/spec.md` — Shell specification
- `design/src/shell/components/AppShell.tsx` — Main shell wrapper
- `design/src/shell/components/MainNav.tsx` — Navigation component
- `design/src/shell/components/UserMenu.tsx` — User menu component
- `design/src/shell/components/index.ts` — Component exports
- `design/src/shell/ShellPreview.tsx` — Preview wrapper
