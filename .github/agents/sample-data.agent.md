...
handoffs:
  - label: Design Screen
    agent: "Design: Screen"
    prompt: "Sample data and types are ready. Create the screen design components for this section."
---
...
Then check if `design/product/sections/[section-id]/spec.md` exists. If it doesn't:
...
Check if `design/product/sections/[section-id]/data.json` already exists.
...
Check if `design/product/data-shape/data-shape.md` exists.
...
Read and analyze `design/product/sections/[section-id]/spec.md` to understand:
...
### Generate `design/product/sections/[section-id]/data.json`
...
### Generate `design/product/sections/[section-id]/types.ts`
...
1. `design/product/sections/[section-id]/data.json` - Sample data with [X] records
2. `design/product/sections/[section-id]/types.ts` - TypeScript interfaces for type safety
