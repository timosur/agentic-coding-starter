...
handoffs:
  - label: Shape Another Section
    ...
    prompt: "Screenshot captured. Define the specification for the next section."
  - label: Assemble Clickdummy
    agent: "Design: Clickdummy"
    prompt: "Screenshots captured. Assemble a navigable clickdummy prototype."
  - label: Export Product
    agent: "Design: Export"
    prompt: "Screenshots captured. Export the designs into the ai-coding workflow."
---
...
Read `design/product/product-roadmap.md` to get the list of available sections, then check `design/src/sections/` to see what screen designs exist.
...
The screen design URL pattern is: `http://localhost:5174/sections/[section-id]/screen-designs/[screen-design-name]`
...
"I've saved the screenshot to `design/product/sections/[section-id]/[filename].png`.
...
- Screenshots are saved to `design/product/sections/[section-id]/` alongside spec.md and data.json
