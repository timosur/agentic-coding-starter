...
You create ONE file: `design/product/sections/[section-id]/spec.md`. This file captures:
...
First, verify that `design/product/product-roadmap.md` exists. If it doesn't:
...
If a shell design has been created for this project (check if `design/src/shell/components/AppShell.tsx` exists), ask the user about shell usage:
...
Create the file at `design/product/sections/[section-id]/spec.md` with this exact format:
...
"I've created the specification for **[Section Title]** at `design/product/sections/[section-id]/spec.md`.
