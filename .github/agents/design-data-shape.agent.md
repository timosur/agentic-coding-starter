...
handoffs:
  - label: Define Design System
    agent: "Design: Design System"
    prompt: "Data shape is defined. Define the visual identity — colors, typography, brand."
  - label: Design Shell
    agent: "Design: Shell"
    prompt: "Data shape is defined. Design the application shell (navigation, layout)."
---
...
First, check if `design/product/data-shape/data-shape.md` exists.
...
- `design/product/product-overview.md` (if it exists, for context)
- `design/product/product-roadmap.md` (if it exists, for context)
...
Wait for the user's response. Once they describe the changes, update `design/product/data-shape/data-shape.md` accordingly.
...
1. `design/product/product-overview.md` to understand what the product does
2. `design/product/product-roadmap.md` to understand the planned sections
...
Once the user has confirmed the entities and relationships, create `design/product/data-shape/data-shape.md` with this format:
...
"I've created your data shape at `design/product/data-shape/data-shape.md`.
