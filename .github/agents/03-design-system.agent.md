...
handoffs:
  - label: Design Shell
    agent: "Design: Shell"
    prompt: "Design system is defined. Design the application shell using these tokens."
---
...
Read `design/product/product-overview.md` to understand what the product is.
...
Check if `design/product/design-system/design-system.json` already exists.

If it exists, also check if there are new or modified files in `design/product/design-system/resources/` by comparing any stored resource references with the current files in the folder.
...
List the contents of `design/product/design-system/resources/` to see what brand assets are available.
...
If yes, create a folder at `design/product/design-system/resources/` and add:
...
For each file in `design/product/design-system/resources/`, analyze its contents:
...
**File 1:** `design/product/design-system/design-system.json`
...
**File 2:** `design/product/design-system/design-system.md` (human-readable documentation)
...
- `design/product/design-system/design-system.json` — Structured data for agents
- `design/product/design-system/design-system.md` — Human-readable documentation
